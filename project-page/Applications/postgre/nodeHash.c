...
*/
/*CSI 3530 : Ajouté par notre groupe | : commencement*/

/* ----------------------------------------------------------------
 *		MultiExecHash
 *		
 *		Build une table de hachage pour hashjoin, qui fait le partitionning
 *		si on a besoin de plus de un batch.
 * 
 * ----------------------------------------------------------------
 */
...
/*CSI 3530 : Ajouté par notre groupe | : fin */
