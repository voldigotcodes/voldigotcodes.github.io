...
Création d'une variable qui va tenir notre outer has plan*/	Hash	   *outer_hash_plan;
...
/*CSI 3530 : Ajouté par notre groupe |
Creation d'un hash node avec le outer plan*/ outer_hash_plan=make_hash(outer_plan);  	
	...
	join_plan = make_hashjoin(tlist,
							  ...
							  hashclauses,
							  /*CSI 3530 : Ajouté par notre groupe |
							  ajout du plan du outer hash a  la creation du has join node
