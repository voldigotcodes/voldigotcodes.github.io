...
typedef struct HashJoinState
{
	...
	HashJoinTable inner_hj_HashTable;	/*CSI 3530 : Ajouté par notre groupe | Creation d'une variable pour la inner hash join hash table*/
	HashJoinTable outer_hj_HashTable;	/*CSI 3530 : Ajouté par notre groupe | Creation d'une variable pour la outer hash join hash table*/
...
/*CSI 3530 : Ajouté par notre groupe | 
variable pour verifier que le inner table is not empty*/	bool		hj_InnerNotEmpty;
